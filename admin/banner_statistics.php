 ...
 * @version $Id: pilou2 2023 Mar 24 Modified in v1.5.8a $
 *
...
for ($i = 1; $i < 13; $i++) {
  $months_array[] = array(
    'id' => $i,
    'text' => $zcDate->output('MMMM', mktime(0, 0, 0, $i)));
}
...
<?php
  ...
  $title = sprintf(
      ...
      $zcDate->output('MMMM', mktime(0,0,0,(isset($_GET['month']) ? (int)$_GET['month'] : date('n')))),
